...
import { FontBold, FontMedium, sharedStyles, STATUS_BAR_HEIGHT, TitleFont } from 'styles/sharedStyles';
...
const LogoAccountTypeStyle: StyleProp<ImageStyle> = { width: 40, height: 40, borderRadius: 10 };
    ...
    (): AccountActionGroup[] => [
      {
        ...
        items: [
          {
            icon: () => <Image source={NewLogosMap.substrate} style={LogoAccountTypeStyle} />,
          ...
          {
            icon: () => <Image source={NewLogosMap.evm} style={LogoAccountTypeStyle} />,
  ...
  return (
    <>
      <SubWalletModal
        ...
        onModalHide={onHideMainModal}
        onChangeModalVisible={onHideMainModal}
        isFullHeight={true}>
