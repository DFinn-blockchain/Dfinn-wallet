...
import { WALLET_CONNECT_EIP155_NAMESPACE, WALLET_CONNECT_POLKADOT_NAMESPACE } from 'utils/walletConnect';
...
const handleConfirm = async ({ id }: any, selectedAccounts: string[]) => {
...
const ConnectWalletConnectConfirmation = ({ request }: Props) => {
        ...
        {isSupportCase && !missingType.length && (
          <>
            ...
            <SubmitButton
              ...
              onPress={onConfirm}
              title={i18n.buttonTitles.approve}
              isBusy={loading}
        ...
        {isSupportCase && !!missingType.length && (
          <>
            ...
            <SubmitButton
              ...
              title={i18n.buttonTitles.createOne}
              disabled={loading}
              style={{ flex: 1 }}
            />
            {/* <Button
