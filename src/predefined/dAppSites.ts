...
export const predefinedDApps: PredefinedDApps = {
  ...
  dapps: [
    ...
    {
      name: 'Edgeverse',
      icon: 'https://d1fdloi71mui9q.cloudfront.net/SOWF5G7rSdi34DvsQemm_bR7qZvCfo59O16Wb',
      url: 'https://edgeverse.exchange',
      categories: ['utilities'],
      // isSupportSubstrateAccount: true,
    },
    {
      name: 'Edgeverse-Bridge',
      icon: 'https://www.edgeware.io/assets/press/edgeware-main-logomark.png',
      url: 'https://bridge.edgeverse.exchange',
      categories: ['utilities'],
      //isSupportSubstrateAccount: true,
    },
    // {
